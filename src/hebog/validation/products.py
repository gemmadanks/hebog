...
from hebog.science.catalogues import (
    ...
    _moment_shape_fields,  # pyright: ignore[reportPrivateUsage]
    _stable_component_catalogue,  # pyright: ignore[reportPrivateUsage]
    _validated_hebog_segment_planes,  # pyright: ignore[reportPrivateUsage]
