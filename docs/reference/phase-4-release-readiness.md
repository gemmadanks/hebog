...
The unseen Phase 4 qualification recipe contains the same affected blend
stratum. Its output has not been inspected. After approval of the amended
association policy, the recipe, manifest checksum, and reviewed population
definitions must be replaced before any qualification run.
