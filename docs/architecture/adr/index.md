...
| [ADR-003: Limit Hebog to Rapthor's source-finding contract](003-limit-hebog-to-rapthor-source-finding-contract.md) | 🟢 Accepted | Implement and qualify only the source-finding behaviour Rapthor consumes |
