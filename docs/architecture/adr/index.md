...
| [ADR-007: Use a gated Zarr intermediate store](007-use-a-gated-zarr-intermediate-store.md) | 🟢 Accepted | Qualify Zarr for distributed intermediate planes while preserving measured small/local fast paths |
