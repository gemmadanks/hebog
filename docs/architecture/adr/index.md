...
| [ADR-008: Make the continuum composition tile-native](008-make-the-continuum-composition-tile-native.md) | 🟡 Proposed | Define the pass structure, halo, ownership, boundary summary and merge of every public continuum stage |
