...
| Next action | Human: set the binding `Total_flux` limits in the M1 row above, and free disk to about 60 GB before the envelope passes 22,500². Agent: continue pass D with the cross-parent loop and extended-residual reconciliation, then source association and the continuum catalogue. |
