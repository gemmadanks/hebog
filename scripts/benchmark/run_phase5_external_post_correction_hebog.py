#!/usr/bin/env python3
"""Run one Hebog leg through the frozen post-correction boundary."""
...
def main() -> None:
    """Install post-correction loaders and unchanged reviewed science."""
    ...
    def corrected_detection(*args: object, **kwargs: object) -> Any:
        """Apply the unchanged reviewed cleanup to one detection result."""
        return candidate["_cleaned_detection"](evaluate, *args, **kwargs)
